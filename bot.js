...
client.on('message', message => {
        ...
        .setURL(`https://discordapp.com/api/oauth2/authorize?client_id=530737840565256192&permissions=8&scope=bot`)
        .setThumbnail("https://discordapp.com/api/oauth2/authorize?client_id=530737840565256192&permissions=8&scope=bot")        
     message.channel.sendEmbed(embed);
       }
   });
